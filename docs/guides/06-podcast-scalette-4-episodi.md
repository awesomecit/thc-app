...
> "Crea la tua applicazione in modo che funzioni senza UI né database, così puoi eseguire test di
> regressione automatici, lavorare quando il database non è disponibile, e collegare applicazioni
> insieme senza intervento umano." - Alistair Cockburn
...
- **KISS** (Keep It Simple, Stupid)
  ...
  - Citazione: "Quando hai dubbi, rimuovi qualcosa. Se il codice funziona ancora e si legge meglio,
    quella complessità non serviva."

- **YAGNI** (You Ain't Gonna Need It)
  - Non implementare feature "per il futuro"
  - Il futuro è imprevedibile
  - Citazione Ron Jeffries: "Implementa sempre le cose quando ne hai effettivamente bisogno, mai
    quando prevedi che ne avrai bisogno."
...
> "È doloroso per la maggior parte degli sviluppatori riconoscerlo, perché amano così tanto il
> codice, ma il codice migliore è nessun codice. Ogni nuova riga di codice che porti volontariamente
> nel mondo è codice che deve essere debuggato, letto e compreso, supportato."

**Rich Skrenta**

> "Il codice è cattivo. Marcisce. Richiede manutenzione periodica. Ha bug da trovare. Nuove feature
> significano che il vecchio codice deve essere adattato. Più codice hai, più posti ci sono dove i
> bug possono nascondersi."
...
> "La complessità non viene scelta consciamente, è il risultato di default dello scegliere ciò che è
> facile."
...
> "Qualsiasi sciocco può scrivere codice che un computer capisce. I buoni programmatori scrivono
> codice che gli umani capiscono."

> "Il refactoring non è un'attività per cui metti da parte tempo. È qualcosa che fai continuamente
> in piccoli burst."
...
> "Lo scopo del design è permetterti di fare design dopo, e il suo obiettivo primario è ridurre il
...
> "Il programmatore competente è pienamente consapevole delle dimensioni strettamente limitate del
> proprio cranio; perciò affronta il task di programmazione con piena umiltà."
...
> "Nel 2016 era già difficile smettere di programmare. Ma ora, con gli strumenti AI, è come se
> avessimo scoperto l'equivalente della metanfetamina per il coding."

**La qualità del "quasi lì"**

> "La sensazione che siamo a un solo prompt dalla soluzione perfetta - è ciò che lo rende così
> dipendente." - Fred Benenson
...
> "Ho cancellato il mio abbonamento dopo 2 mesi perché stavo spendendo troppo sforzo mentale a
> rivedere tutto il 'vomito di codice' correggendo tutti gli errori. Piango per i junior che saranno
> schiacciati da questa spazzatura."
...
- Definizione ironica: "Ti abbandoni completamente alle vibes, abbracci gli esponenziali e
  dimentichi che il codice esista."
